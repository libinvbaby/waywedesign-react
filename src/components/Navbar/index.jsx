          ...
          <li className="nav-item">
            ...
            <li className="nav-item dropdown" onClick={handleDropdown}>
              ...
              <div className="dropdown-menu">
                <Link href="/graphic-design-company-kochi">
                  <a className="dropdown-item">Graphical Dynamite</a>
                </Link>
                <Link href="/web-development-company-in-kochi">
                  <a className="dropdown-item">Web Design/ Development</a>
                </Link>
            ...
            <li className="nav-item">
              <Link href="/blog/blog-light">
                <a className="nav-link">Carrers</a>
              </Link>
            </li>
            {/* <li className="nav-item dropdown" onClick={handleDropdown}>
              <span
